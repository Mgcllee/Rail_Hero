...
inline bool PacketType::has_c2sloginuserreq() const {
  return Type_oneof_case() == kC2SLoginUserReq;
}
...
inline void PacketType::clear_c2sloginuserreq() {
  ...
  if (Type_oneof_case() == kC2SLoginUserReq) {
    if (GetArena() == nullptr) {
...
inline ::User::C2SPCLoginUserReq* PacketType::release_c2sloginuserreq() {
  ...
  if (Type_oneof_case() == kC2SLoginUserReq) {
    clear_has_Type_oneof();
    auto* temp = _impl_.Type_oneof_.c2sloginuserreq_;
    if (GetArena() != nullptr) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
    _impl_.Type_oneof_.c2sloginuserreq_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::User::C2SPCLoginUserReq& PacketType::_internal_c2sloginuserreq() const {
  return Type_oneof_case() == kC2SLoginUserReq ? *_impl_.Type_oneof_.c2sloginuserreq_ : reinterpret_cast<::User::C2SPCLoginUserReq&>(::User::_C2SPCLoginUserReq_default_instance_);
}
...
inline void PacketType::unsafe_arena_set_allocated_c2sloginuserreq(::User::C2SPCLoginUserReq* value) {
  ...
  if (value) {
    ...
    _impl_.Type_oneof_.c2sloginuserreq_ = value;
  }
...
inline ::User::C2SPCLoginUserReq* PacketType::_internal_mutable_c2sloginuserreq() {
  if (Type_oneof_case() != kC2SLoginUserReq) {
    clear_Type_oneof();
    set_has_c2sloginuserreq();
    _impl_.Type_oneof_.c2sloginuserreq_ = CreateMaybeMessage<::User::C2SPCLoginUserReq>(GetArena());
  }
  return _impl_.Type_oneof_.c2sloginuserreq_;
}
...
inline bool PacketType::has_s2cloginuserres() const {
  return Type_oneof_case() == kS2CLoginUserRes;
}
...
inline void PacketType::clear_s2cloginuserres() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  if (Type_oneof_case() == kS2CLoginUserRes) {
    if (GetArena() == nullptr) {
...
inline ::User::S2CPCLoginUserRes* PacketType::release_s2cloginuserres() {
  ...
  if (Type_oneof_case() == kS2CLoginUserRes) {
    clear_has_Type_oneof();
    auto* temp = _impl_.Type_oneof_.s2cloginuserres_;
    if (GetArena() != nullptr) {
      temp = ::google::protobuf::internal::DuplicateIfNonNull(temp);
    }
    _impl_.Type_oneof_.s2cloginuserres_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline const ::User::S2CPCLoginUserRes& PacketType::_internal_s2cloginuserres() const {
  return Type_oneof_case() == kS2CLoginUserRes ? *_impl_.Type_oneof_.s2cloginuserres_ : reinterpret_cast<::User::S2CPCLoginUserRes&>(::User::_S2CPCLoginUserRes_default_instance_);
}
...
inline void PacketType::unsafe_arena_set_allocated_s2cloginuserres(::User::S2CPCLoginUserRes* value) {
  ...
  if (value) {
    ...
    _impl_.Type_oneof_.s2cloginuserres_ = value;
  }
...
inline ::User::S2CPCLoginUserRes* PacketType::_internal_mutable_s2cloginuserres() {
  if (Type_oneof_case() != kS2CLoginUserRes) {
    clear_Type_oneof();
    set_has_s2cloginuserres();
    _impl_.Type_oneof_.s2cloginuserres_ = CreateMaybeMessage<::User::S2CPCLoginUserRes>(GetArena());
  }
  return _impl_.Type_oneof_.s2cloginuserres_;
}
...
inline bool PacketType::has_Type_oneof() const {
  return Type_oneof_case() != TYPE_ONEOF_NOT_SET;
}
inline void PacketType::clear_has_Type_oneof() {
  _impl_._oneof_case_[0] = TYPE_ONEOF_NOT_SET;
}
inline PacketType::TypeOneofCase PacketType::Type_oneof_case() const {
  return PacketType::TypeOneofCase(_impl_._oneof_case_[0]);
}
// -------------------------------------------------------------------
